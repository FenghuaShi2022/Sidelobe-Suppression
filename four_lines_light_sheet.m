...
NA_outer=0.45;%outer NA of the annular ring
radius_outer=focal_length*tan(asin(NA_outer));%outer annular ring radius
NA_inner=0.20;%inner NA of the annular ring
radius_inner=focal_length*tan(asin(NA_inner));%inner annular ring radius
NA_x_lines=0.15;%NA location of the four line beams at the rear pupil plane
x_lines=focal_length*tan(asin(NA_x_lines)); % x postion of the four line beams at the rear pupil plane
...
%%%%%%%%%%%
tic
y_imaging=linspace(focal_length*2-8*wavelength, focal_length*2+8*wavelength,2*20*10);
...
% load  relative_P_1st_side_four_line.mat   % P_1st_side for the a1 line beams
